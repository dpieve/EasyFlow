...
public sealed class Edit
{
    ...
    {
        public required Domain.Entities.GeneralSettings Settings { get; init; }
    }
    ...
    public sealed class CommandValidator : AbstractValidator<Command>
    {
        ...
        {
            RuleFor(x => x.Settings).NotNull().SetValidator(new SettingsValidator());
        }
    }
    ...
    public sealed class Handler : IRequestHandler<Command, Result<Unit>>
    {
        ...
        public async Task<Result<Unit>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var found = await _context.GeneralSettings.FindAsync(request.Settings.Id, cancellationToken);
            ...
            _mapper.Map(request.Settings, found);
